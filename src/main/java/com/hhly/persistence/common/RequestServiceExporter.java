...
public class RequestServiceExporter  extends HessianExporter implements HttpRequestHandler {  
	private static final Logger logger = LoggerFactory.getLogger(RequestServiceExporter.class);  
