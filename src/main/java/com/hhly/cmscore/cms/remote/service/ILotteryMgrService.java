...
public interface ILotteryMgrService {
	 ...
	 * @return
	 */
	List<LotteryTypeBO> findLotteryName(List<String> ids);
	/**
	 * @desc 查询多个子玩法列表
	 * @author huangb
	 * @date 2017年1月19日
	 ...
	 * @author jiangwei
	 * @Version 1.0
	 * @CreatDate 2017-2-6 下午6:04:09
	 * @param childCodes
	 * @return
	 */
	Map<String, String> listChildTypeName(Collection<String> code);
	
    /**
     * 查询当前彩期
     * @author jiangwei
     * @Version 1.0
     * @CreatDate 2017-2-14 下午5:15:03
     * @param adminCategory 彩种类型
     * @return
     */
    List<LotteryIssueCmsBO> listCurrentIssue(String lotteryCategory);
	 ...
	 * @author jiangwei
	 * @Version 1.0
	 * @CreatDate 2017年3月13日 上午11:48:03
	 * @param vo
	 * @return
	 */
