...
public class OperateCouponTempPO {
	private Integer id;
    /**
     * 关联的配置表id
     */
	...
	public OperateCouponTempPO(OperateCouponTempVO vo){
    	this.id = vo.getId();
    ...
    public OperateCouponTempPO(OperateActivityAwardVO vo){
    	this.id = vo.getTypeCode()==null||"".equals(vo.getTypeCode())?null:Integer.valueOf(vo.getTypeCode());
    	this.configId = vo.getActivityConfigId();
    	this.channelId = vo.getChannelId();
    	this.createBy = vo.getCreateBy();
    	this.createTime = vo.getCreateTime();
    	this.ectivityDay = vo.getEctivityDay();
    	...
    	this.redValue = vo.getRedValue();
    	this.updateTime = vo.getUpdateTime();
    	this.configType=CouponConfigTypeEnum.ACTIVITY.getValue();
    }
    public OperateCouponTempPO(OperateActivityAddedVO vo){
    	this.id = vo.getOperateActivityCouponId()==null||"".equals(vo.getOperateActivityCouponId())?null:vo.getOperateActivityCouponId();
    	this.activeEndTime = vo.getActiveEndTime();
    	this.configId = vo.getActivityConfigId();
    	this.channelId = vo.getChannelId();
    	this.createBy = vo.getCreateBy();
