 ...
 *  @Version 1.0.0
 */
public class OperateMsgTemplatePO{
	...
	public OperateMsgTemplatePO(){
    	
    }
    
    public OperateMsgTemplatePO(OperateMsgTemplateVO vo){
    	this.id = vo.getId();
        ...
        this.appAddFields = vo.getAppAddFields();
        ...
        this.conditionKey = vo.getConditionKey();
        this.startDays = vo.getStartDays();
        this.endDays = vo.getEndDays();
        this.lotteryCodeLimit = vo.getLotteryCodeLimit();
        this.setMoney = vo.getSetMoney();
        this.setBalance = vo.getSetBalance();
        this.smsSendChannel = vo.getSmsSendChannel();
        this.noSendChannel = vo.getNoSendChannel();
        this.sendLotteryCode = vo.getSendLotteryCode();
    }
