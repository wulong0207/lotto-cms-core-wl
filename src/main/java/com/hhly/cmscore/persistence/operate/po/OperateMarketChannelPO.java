...
public class OperateMarketChannelPO {
	...
	public OperateMarketChannelPO() {
		
	}

	public OperateMarketChannelPO(OperateMarketChannelVO vo) {
		this.id = vo.getId();
		this.channelId = vo.getChannelId();
		this.channelName = vo.getChannelName();
		this.terminalPlatform = vo.getTerminalPlatform();
		this.parentChannelId = vo.getParentChannelId();
		this.grade = vo.getGrade();
		this.settlementType = vo.getSettlementType();
		this.resourceUrl = vo.getResourceUrl();
		this.settlementRate = vo.getSettlementRate();
		this.coopStartTime = vo.getCoopStartTime();
		this.coopEndTime = vo.getCoopEndTime();
