 ...
 * @version 1.0
 */
public class OperateActivityLottoPO {
	...
	public OperateActivityLottoPO() {

	}

	public OperateActivityLottoPO(OperateActivityLottoVO vo) {
		this.id = vo.getId();
		...
		this.pickType = vo.getPickType();
		this.buyType = vo.getBuyType();
