...
public class OperateActivityRulePO {
    /**
     * 规则主键id
     */
    private Integer id;
    ...
    public OperateActivityRulePO() {
    	
    }
    public OperateActivityRulePO(OperateActivityRuleVO vo) {
    	this.id = vo.getId();
		...
		this.winStartMoney = vo.getWinStartMoney();
		this.winEndMoney = vo.getWinEndMoney();
		this.rebateType = vo.getRebateType();
		this.rebateNum = vo.getRebateNum();
		this.isMultiple = vo.getIsMultiple();
		this.multipleSub = vo.getMultipleSub();
		this.addedAdd = vo.getAddedAdd();
		this.userAction = vo.getUserAction();
		this.giftType = vo.getGiftType();
		this.giftMoney = vo.getGiftMoney();
		this.status = vo.getStatus();
		this.createBy = vo.getCreateBy();
		this.modifyBy = vo.getModifyBy();
		this.contentType=vo.getContentType();
		this.isAdd = vo.getIsAdd();
	}
    public OperateActivityRulePO(OperateActivityRechargeVO vo) {
    	this.id = vo.getId();
		this.activityConfigId = vo.getActivityConfigId();
		this.createBy = vo.getCreateBy();
		this.modifyBy = vo.getModifyBy();
