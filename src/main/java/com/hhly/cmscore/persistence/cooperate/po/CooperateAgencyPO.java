...
public class CooperateAgencyPO {
    /**
     * 主键
     */
    private Integer id;
    ...
    public CooperateAgencyPO(CooperateAgencyVO vo) {
        this.id = vo.getId();
        this.channelId = vo.getChannelId();
        this.cooperateChannelId = vo.getCooperateChannelId();
        this.returnRate = vo.getReturnRate();
